        ...
        body: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text('i was born here', textDirection: TextDirection.ltr),
              Text('For real', textDirection: TextDirection.ltr),
            ],
          ),
        ));
  }
    ...
    return Scaffold(
      ...
      body: Container(
        child: Row(
          ...
          children: <Widget>[
            Text('Peter', textDirection: TextDirection.ltr),
            Text('MJ', textDirection: TextDirection.ltr),
            Text('Miles', textDirection: TextDirection.ltr),
            Text('May', textDirection: TextDirection.ltr),
          ],
        ),
      ),
    );
